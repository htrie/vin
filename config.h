...
struct Spacing {
	...
	SmallString increase_char_width() { character = clamp(character + 0.05f, 0.0f, 2.0f); return SmallString("char_width = ") + SmallString(character); }
	SmallString decrease_char_width() { character = clamp(character - 0.05f, 0.0f, 2.0f); return SmallString("char_width = ") + SmallString(character); }

	SmallString increase_char_height() { line = clamp(line + 0.05f, 0.0f, 2.0f); return SmallString("char_height = ") + SmallString(line); }
	SmallString decrease_char_height() { line = clamp(line - 0.05f, 0.0f, 2.0f); return SmallString("char_height = ") + SmallString(line); }
