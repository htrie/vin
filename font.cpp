...
void output_include(const std::array<Symbol, 128>& symbols, unsigned total_vertex_count) {
...
void output_header(const std::array<Symbol, 128>& symbols) {
...
int APIENTRY WinMain(HINSTANCE hCurrentInst, HINSTANCE hPreviousInst, LPSTR lpszCmdLine, int nCmdShow) {
    ...
    std::array<Symbol, 128> symbols; // ASCII table. // [TODO] Consider using 256 ASCII table to get full block for instance.
