...
namespace Device
{
	...
	PixelFormat UnconvertPixelFormat(DXGI_FORMAT format)
	{
		...
		case DXGI_FORMAT_BC1_UNORM_SRGB:		return PixelFormat::DXT1;
		case DXGI_FORMAT_BC2_UNORM_SRGB:		return PixelFormat::DXT3;
		case DXGI_FORMAT_BC3_UNORM_SRGB:		return PixelFormat::DXT5;
	...
	DXGI_FORMAT ConvertPixelFormat(PixelFormat format, bool useSRGB)
	{
		...
		case PixelFormat::DXT1:					return (useSRGB) ? DXGI_FORMAT_BC1_UNORM_SRGB : DXGI_FORMAT_BC1_UNORM;
		case PixelFormat::DXT2:					return (useSRGB) ? DXGI_FORMAT_BC2_UNORM_SRGB : DXGI_FORMAT_BC2_UNORM;
		case PixelFormat::DXT3:					return (useSRGB) ? DXGI_FORMAT_BC2_UNORM_SRGB : DXGI_FORMAT_BC2_UNORM;
		case PixelFormat::DXT4:					return (useSRGB) ? DXGI_FORMAT_BC3_UNORM_SRGB : DXGI_FORMAT_BC3_UNORM;
		case PixelFormat::DXT5:					return (useSRGB) ? DXGI_FORMAT_BC3_UNORM_SRGB : DXGI_FORMAT_BC3_UNORM;
