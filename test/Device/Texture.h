...
namespace Device
{
	...
	enum class PixelFormat : unsigned
	{
		...
		DXT1 = MakePixelFormat('D', 'X', 'T', '1'),
		DXT2 = MakePixelFormat('D', 'X', 'T', '2'),
		DXT3 = MakePixelFormat('D', 'X', 'T', '3'),
		DXT4 = MakePixelFormat('D', 'X', 'T', '4'),
		DXT5 = MakePixelFormat('D', 'X', 'T', '5'),
		D16_LOCKABLE = 70,
		D32 = 71,
		D15S1 = 73,
		D24S8 = 75,
	...
	public:
		...
		virtual void CopyResource(Texture* texture) = 0;
	...
	constexpr unsigned GetBitsPerPixel(PixelFormat format)
	{
		switch (format)
		{
			...
			case PixelFormat::DXT2:					return 8;
			case PixelFormat::DXT3:					return 8;
			case PixelFormat::DXT4:					return 8;
