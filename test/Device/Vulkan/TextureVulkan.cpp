...
namespace Device
{
	...
	vk::Format ConvertPixelFormatVulkan(PixelFormat format, bool useSRGB)
	{
		...
		case PixelFormat::DXT1:					return useSRGB ? vk::Format::eBc1RgbaSrgbBlock : vk::Format::eBc1RgbaUnormBlock;
		case PixelFormat::DXT2:					return useSRGB ? vk::Format::eBc2SrgbBlock : vk::Format::eBc2UnormBlock;
		case PixelFormat::DXT3:					return useSRGB ? vk::Format::eBc2SrgbBlock : vk::Format::eBc2UnormBlock;
		case PixelFormat::DXT4:					return useSRGB ? vk::Format::eBc3SrgbBlock : vk::Format::eBc3UnormBlock;
		case PixelFormat::DXT5:					return useSRGB ? vk::Format::eBc3SrgbBlock : vk::Format::eBc3UnormBlock;
	...
	void TextureVulkan::CopyResource(Texture* pSrcResource)
	{
	}
