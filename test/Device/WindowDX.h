...
namespace Device
{
	...
	public:
		...
		typedef HRESULT(CALLBACK *DeviceResetCallback)(IDevice* pd3dDevice, const SurfaceDesc* pBackBufferSurfaceDesc, void* pUserContext);
	...
	public:
		...
		void TriggerDeviceReset(IDevice* device, const SurfaceDesc* desc);
