...
namespace Device
{
	...
	Gnm::DataFormat ConvertPixelFormat(PixelFormat format, bool useSRGB)
	{
		...
		case PixelFormat::DXT1:					return useSRGB ? Gnm::kDataFormatBc1UnormSrgb : Gnm::kDataFormatBc1Unorm;
		case PixelFormat::DXT2:					return useSRGB ? Gnm::kDataFormatBc2UnormSrgb : Gnm::kDataFormatBc2Unorm;
		case PixelFormat::DXT3:					return useSRGB ? Gnm::kDataFormatBc2UnormSrgb : Gnm::kDataFormatBc2Unorm;
		case PixelFormat::DXT4:					return useSRGB ? Gnm::kDataFormatBc3UnormSrgb : Gnm::kDataFormatBc3Unorm;
		case PixelFormat::DXT5:					return useSRGB ? Gnm::kDataFormatBc3UnormSrgb : Gnm::kDataFormatBc3Unorm;
	...
	void TextureGNMX::CopyResource(Texture* pSrcResource)
	{
	}
