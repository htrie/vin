...
namespace Renderer
{
	...
	namespace Scene
	{
...
#endif
			void EnableBreachEffect();
			void DisableBreachEffect();
			void UpdateBreachSphere(simd::vector3 sphere_position, float sphere_radius );
			const simd::vector4& GetBreachInfo() const;
		...
		private:
			...
			std::unique_ptr< Device::Font > viewmode_font;
			std::unique_ptr< Device::SpriteBatch > viewmode_sprite_batch;
#endif
			...
			bool breach_effect_enabled = false;
