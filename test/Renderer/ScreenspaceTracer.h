...
namespace Renderer
{
	...
	public:
		...
		void RenderWireframe(Device::Line& line, const simd::matrix& view_projection, float veritcal_offset, simd::color color) const;
	...
	public:
		...
		void RenderWireframe(Device::Line & line, const simd::matrix & view_projection);
