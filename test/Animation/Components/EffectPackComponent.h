...
namespace Animation
{
	namespace Components
	{
		...
		public:
			...
			bool GetEffectPackRemoveOnAnimationEnd( const unsigned index ) const { return effect_packs[ index ].remove_on_animation_end; }
	...
	public:
		...
		AppliedEffectPackHandle& operator=( AppliedEffectPackHandle&& ) = default;
