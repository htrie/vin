...
namespace Animation
{
	...
	namespace Components
	{
		...
		public:
			...
			MaterialHandle GetMaterial( const Mesh::AnimatedMeshHandle& mesh, const unsigned segment_index ) const { return static_ref.GetMaterial( mesh, segment_index, fallback_material_overrides ); }
