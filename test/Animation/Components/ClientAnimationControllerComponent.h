...
namespace Animation
{
	...
	namespace Components
	{
		...
		private:
			...
			virtual void OnAppendAnimation(const AnimationController& controller, const CurrentAnimation& animation, const bool blend, const std::string& mask_bone_group) override;
