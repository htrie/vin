...
namespace Particles
{
	...
	void ParticleEmitter3d::GenerateCreateInfo(Entity::Desc& desc, Device::CullMode cull_mode) const // IMPORTANT: Keep in sync with EmitterTemplate::Warmup. // [TODO] Share.
	{
		...
		desc.SetType(Renderer::DrawCalls::Type::Particle)
			...
			.AddObjectUniforms(Renderer::DrawCalls::Uniforms()
				.Add(Renderer::DrawDataNames::WorldTransform, simd::matrix::identity()) // Note: world transform is always identity since the particle merging change
				.Add(Renderer::DrawDataNames::FlipTangent, cull_mode == Device::CullMode::CW ? -1.0f : 1.0f)
				.Add(Renderer::DrawDataNames::StartTime, -100.0f)
				.Add(Renderer::DrawDataNames::ParticleOffset, particle_offset)
				.Add(Renderer::DrawDataNames::ParticleRotationOffset, rotation_offset)
				.Add(Renderer::DrawDataNames::ParticleNumFrames, particle_numframes)
				.Add(Renderer::DrawDataNames::ParticleEmitterPos, center_pos)
				.Add(Renderer::DrawDataNames::ParticleEmitterTransform, emitter_world_transform))
