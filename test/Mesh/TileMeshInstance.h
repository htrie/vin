...
namespace Mesh
{
	...
	private:
		...
		void CreateGroundEntityDesc(Entity::Desc& desc, const TileMeshRawData::MeshSection& mesh, const BoundingBox& bounding_box);
		void CreateNormalEntityDesc(Entity::Desc& desc, const TileMeshRawData::MeshSection& mesh, const MergedMeshSectionSegment& merged_segment, const BoundingBox& bounding_box);
		void CreateWetnessEntityDesc(Entity::Desc& desc, const TileMeshRawData::MeshSection& mesh, const MergedMeshSectionSegment& merged_segment, const BoundingBox& bounding_box);
