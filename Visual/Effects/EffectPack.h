...
namespace Visual
{
	...
	public:
		...
		Loaders::MiscEffectPacks_Row_Handle GetBeginEffectPack() const { return play_epk_on_begin; }
		Loaders::MiscEffectPacks_Row_Handle GetEndEffectPack() const { return play_epk_on_end; }

		bool IsParentOnlyEffects() const { return parent_only_effects; }
		void SetParentOnlyEffects( const bool parent_only ) { parent_only_effects = parent_only; }

		float GetPlayStartEpkAfterDelay() const { return play_start_epk_after_delay; }
		void SetBeginEffectPack( const Loaders::MiscEffectPacks_Row_Handle row, const float delay );
		void SetEndEffectPack( const Loaders::MiscEffectPacks_Row_Handle row );
		...
		void AddMaterialPass(const MaterialDesc& material, const unsigned pass_index, ApplyMode apply_mode, const bool apply_on_children);
	...
	private:
		...
		Loaders::MiscEffectPacks_Row_Handle play_epk_on_begin;
		Loaders::MiscEffectPacks_Row_Handle play_epk_on_end;
