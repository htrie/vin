...
namespace Environment
{
	...
	struct LoadedEnvironment
	{
		...
		Data saved_data;
		std::vector< Data > undo_chain;
		size_t current_undo_position = 0;
	...
	public:
		...
		static void BlendData( const Data** datum, const float* weights, size_t count, Environment::BlendTypes blend_type, Data* dst_data );
