...
namespace Entity
{
	...
	class Desc : public Template
	{
		...
		GpuParticles::EmitterId gpu_emitter;
	...
	public:
		...
		Desc& SetGpuEmitter(const GpuParticles::EmitterId& emitter_id);
	};
	...
	struct Entity
	{
		...
		Entity() {}
		Entity(const Desc& desc, const std::shared_ptr<Template>& templ);
	};
	typedef Memory::SparseSet<Entity, MaxCount, Memory::Tag::Entities, uint16_t> Entities;
