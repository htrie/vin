...
namespace Renderer
{
	namespace DrawCalls
	{
		...
		void EffectGraphStateOverwrite::Reset()
		{
			...
			depth_stencil.compare_mode.Reset();
		...
		unsigned int EffectGraphStateOverwrite::Hash() const
		{
			...
			hash = EffectGraphUtil::MergeTypeId(hash, depth_stencil.compare_mode.Hash());
		...
		void EffectGraphStateOverwrite::Merge(const EffectGraphStateOverwrite& other)
		{
			...
			depth_stencil.compare_mode.Merge(other.depth_stencil.compare_mode);
		...
		void EffectGraphStateOverwrite::Overwrite(Device::DepthStencilState& state, BlendMode blend_mode) const
		{
			...
			depth_stencil.compare_mode.Overwrite(state.depth.compare_mode);
